...
Veja o exemplo abaixo cria um estilo chamado \texttt{LabStyle}. O código deve
...
\makepagestyle{LabStyle}
  %%cabeçalhos
  \makeevenhead{LabStyle} %%pagina par
     {topo par à esquerda}
     {centro \thepage}
     {direita}
  \makeoddhead{LabStyle} %%pagina ímpar ou com oneside
     {topo ímpar/oneside à esquerda}
     {centro\thepage}
     {direita}
  \makeheadrule{LabStyle}{\textwidth}{\normalrulethickness} %linha
  %% rodapé
  \makeevenfoot{LabStyle}
     {rodapé par à esquerda} %%pagina par
     {centro \thepage}
     {direita} 
  \makeoddfoot{LabStyle} %%pagina ímpar ou com oneside
